...
export default function NavBar({ session }: { session: Session | null }) {
  ...
  return (
    <>
      ...
      >
        <div style={{ maxWidth:1080 }} className="mx-5 flex h-16 items-center justify-between xl:mx-auto">
          <Link href="/" className="flex items-center font-display text-2xl">
          <svg width="110" height="86.94525787694965" viewBox="0 0 350 96.30012739535563" >
              <defs id="SvgjsDefs4440"/>
              <g id="SvgjsG4441" transform="matrix(5.569701152082349,0,0,5.569701152082349,-3.3418108646396725,-16.542012581035003)" fill="#000">
